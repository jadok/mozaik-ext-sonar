...
var Metric = function (_Component) {
  ...
  Metric.prototype.render = function render() {
    ...
    var lastRelease = (0, _utils.formatDate)(data && data.project && data.project.component && data.project.component.leakPeriodDate ? data.project.component.leakPeriodDate : null);
